...
import net.clozynoii.slsb.procedures.MarkProjectileProjectileHitsLivingEntityProcedure;
...
public class MarkProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		MarkProjectileProjectileHitsLivingEntityProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ(), entityHitResult.getEntity(), this.getOwner());
	}
