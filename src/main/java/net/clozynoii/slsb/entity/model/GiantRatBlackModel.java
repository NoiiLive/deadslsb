...
public class GiantRatBlackModel extends GeoModel<GiantRatBlackEntity> {
	@Override
	public ResourceLocation getAnimationResource(GiantRatBlackEntity entity) {
		return new ResourceLocation("slsb", "animations/largerat.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(GiantRatBlackEntity entity) {
		return new ResourceLocation("slsb", "geo/largerat.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(GiantRatBlackEntity entity) {
