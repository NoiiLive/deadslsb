...
BlockPos.containing(x-37,y-2,z-16),
BlockPos.containing(x-37,y-2,z-16),
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-28,y,z-12),
BlockPos.containing(x-28,y,z-12),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-19,y,z-11),
BlockPos.containing(x-19,y,z-11),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-19,y,z-6),
BlockPos.containing(x-19,y,z-6),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-18,y,z-9),
BlockPos.containing(x-18,y,z-9),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-18,y,z-6),
BlockPos.containing(x-18,y,z-6),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
