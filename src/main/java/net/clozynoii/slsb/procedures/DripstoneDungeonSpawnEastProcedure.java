				...
				if ((world.getBlockState(BlockPos.containing(x + 18, y, z))).is(BlockTags.create(new ResourceLocation("slsb:dungeon_unplaceable"))) == false
					...
					if (random == 1) {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x + 1, y - 2, z - 16), BlockPos.containing(x + 1, y - 2, z - 16),
					...
					if (random == 2) {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x + 1, y, z - 12), BlockPos.containing(x + 1, y, z - 12), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
					...
					if (random == 3) {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x + 1, y, z - 11), BlockPos.containing(x + 1, y, z - 11), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
										_serverworld.random, 3);
							}
						}
					}
					if (random == 4) {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x + 1, y, z - 6), BlockPos.containing(x + 1, y, z - 6), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
										_serverworld.random, 3);
							}
						}
					}
					...
					if (random == 6) {
						if (world instanceof ServerLevel _serverworld) {
							...
							if (template != null) {
								template.placeInWorld(_serverworld, BlockPos.containing(x + 1, y, z - 9), BlockPos.containing(x + 1, y, z - 9), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
										_serverworld.random, 3);
							}
						}
					}
					...
					if (world instanceof ServerLevel _serverworld) {
						...
						if (template != null) {
							template.placeInWorld(_serverworld, BlockPos.containing(x + 0, y, z - 6), BlockPos.containing(x + 0, y, z - 6), new StructurePlaceSettings().setRotation(Rotation.NONE).setMirror(Mirror.NONE).setIgnoreEntities(false),
									_serverworld.random, 3);
						}
					}
				}
