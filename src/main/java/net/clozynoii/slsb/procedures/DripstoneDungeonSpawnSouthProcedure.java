...
BlockPos.containing(x-16,y-2,z+1),
BlockPos.containing(x-16,y-2,z+1),
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-12,y,z+1),
BlockPos.containing(x-12,y,z+1),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
...
if (template != null) {
template.placeInWorld(_serverworld,
BlockPos.containing(x-11,y,z+1),
BlockPos.containing(x-11,y,z+1),
new StructurePlaceSettings()
.setRotation(Rotation.NONE)
.setMirror(Mirror.NONE)
